...
const Hero = () => {
  ...
  return (
 <div className="relative bg-gradient-to-br from-[#fbf8f8] via-[#c0c0c3] to-[#c0c0c3] pt-36 pb-32 md:pt-28 md:pb-40 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:py-20 sm:px-6 lg:px-8 relative z-10">
